package com.bob.retrowars_collection_games
...
import com.bob.retrowars_collection_games.core.*
import com.bob.retrowars_collection_games.games.BetaInfo
import com.bob.retrowars_collection_games.games.GameDetails
import com.bob.retrowars_collection_games.net.ServerHostAndPort
...
class RetrowarsGame(val platform: Platform, private val verbose: Boolean, private val forceRandomAvatars: Boolean = false) : Game() {
    ...
    fun unmute() {
        menuMusic.volume = Options.getRealMusicVolume()
    }
