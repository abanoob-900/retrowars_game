...
import com.bob.retrowars_collection_games.utils.MulticastControl
    ...
    override fun shareRetrowars() {
        val sendIntent = Intent().apply {
            ...
            val text = """
                ...
                https://play.google.com/store/apps/details?id=com.bob.retrowars_collection_games
            """.trimIndent()
...
class AndroidMulticastControl(private val context: Context): MulticastControl {
    ...
    override fun acquireLock() {
        ...
        val wifi = context.applicationContext.getSystemService(Context.WIFI_SERVICE) as WifiManager
        lock = wifi.createMulticastLock("com.bob.retrowars_collection_games").apply {
